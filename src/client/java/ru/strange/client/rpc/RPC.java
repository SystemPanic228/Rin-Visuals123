...
public class RPC implements Helper {
    ...
    public void startRpc() {
        ...
        if (!started) {
            ...
            rpc.Discord_Initialize("1429892516769169538", handlers, true, "");
            presence.startTimestamp = (System.currentTimeMillis() / 1000L);
            presence.largeImageText = "Rin Visuals - 1.21.8";
            ...
            thread = new Thread(() -> {
                while (!Thread.currentThread().isInterrupted()) {
                    ...
                    presence.largeImageKey = "https://i.ibb.co/spMBswtj/image.jpg";
